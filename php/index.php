...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="siteHolder animated fadeInDown">
            ...
            <form action="genlink.php" method="POST">
                <input id="message" 
                    maxlength="41"  
                ...
                <!-- <input type="button" id="copy-button" title="Click to copy me.">Copy to Clipboard</button>
                <span class="inline_info">
                    <a id="view_copy" style="cursor: pointer;">copy to clipboard
                    </a>
                </span> -->
